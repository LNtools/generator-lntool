...
describe('Testing OL class', function() {
    describe('OL.bucketImg(_src, _w)', function() {
        ...
        let img_no_bucket  = "http://imagenpng.com/wp-content/uploads/2015/09/imagenes-png-635x508.png";
        let img_bucket  = "http://bucket.glanacion.com/lntools/anexos/fotos/75/375.jpg";
        let width_img = 300;
    ...
    describe('OL.paramToObj(u)', function() {
        let u = "http://localhost:8080/#distrito=Buenos%20Aires&partido=&tv_style=true";
        ...
        it('Return empty obj from empty hash'); // let url_patt = "http://olcreativa.lanacion.com.ar/dev/get_url/?key2={{gkey}}&output=json&gid={{gid}}"
    ...
    describe('OL.getGdocUrlCdn(gdoc_url)', function() {
        ...
        it('Check url pattern'); // let url_patt = "http://olcreativa.lanacion.com.ar/dev/get_url/?key2={{gkey}}&output=json&gid={{gid}}"
